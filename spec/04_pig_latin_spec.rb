...
describe "#translate" do
  ...
  it "capitalizes the newly created word if word was capitalized" do
    s = translate ("Run away")
    expect(s).to eq("Unray awayay")
  end
  # * retain the punctuation from the original phrase
  it "Retains punctuation of the original phrase" do
    s = translate (What? No way!)
    expect(s).to eq("Atwhay! Onay ayway")
  end
end
